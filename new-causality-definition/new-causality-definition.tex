...
\begin{figure}[H]
    ...
    \caption{An example illustrating the step-by-step resolution procedure \TODO{legend}}
    \label{fig:causality-resolution-example}
\end{figure}

Mention that it is simplified
...
\section{Evaluation of Correctness}

I did not do any proofs, so the correctness of the procedure is done empirically
