...
\section{Adapting the Definition of Binder et al.}

To adapt the definition given by Binder et al. we should start with identifying the source of timing anomaly in case of branch predictor. In Binder's work the source was the variation was the latency, 
...
\begin{figure}[H]
    ...
    \end{tabular}
    \caption{}
    \label{Input trace that produces branch-related TA}
\end{figure}


\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/simple-branch-ta.png}
    \caption{Execution trace with correct prediction is longer than the one with incorrect}
    \label{fig:simple-ta-trace}
\end{figure}
...
\subsection{Formal Requirements for Causality Graph}
