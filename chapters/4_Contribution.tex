...
\begin{example}
We consider an instruction trace from Figure \ref{fig:lat-mispred-ta-input} the pair of executino traces with TA is shown at Figure \ref{fig:lat-mispred-ta-trace}. Here the variation is in latency of $B$, but the effect propagates through misprediction region of $F$ which consists of one instruction $G$. 
